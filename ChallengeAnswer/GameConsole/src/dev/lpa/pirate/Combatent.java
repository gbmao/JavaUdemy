...
public sealed abstract class Combatent implements Player permits Islander, Pirate, Soldier {
    ...
    public Combatent(String name, Map<String, Integer> gameData) {
        this.name = name;
        if(gameData != null) {
    ...
    boolean useWeapon(Combatent opponent) {
