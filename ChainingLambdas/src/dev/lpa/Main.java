...
public class Main {
    public static void main(String[] args) {
        ...
        Function<String, String> uCase2 = s -> s.concat("othy");
        System.out.println(uCase.apply(name));

        Function<String, String> lastName = s -> s.concat(" Buchalka");
        Function<String, String> uCaseLastName = uCase.andThen(lastName);
        Function<String, String> uCaseLastName2 = uCase2.andThen(lastName);
        System.out.println(uCaseLastName.apply(name));
        System.out.println(uCaseLastName2.apply(name));
        ...
        Function<String, Integer> f20 = uCase
                .andThen(s -> s.concat(" Buchalka"))
                .andThen(s -> s.split(" "))
                .andThen(s -> String.join(", ", s))
                .andThen(String::length);
        System.out.println(f20.apply(name));
