...
//        Arrays.asList(seats).forEach(System.out::println);
        ...
        System.out.println("Has booking = " + hasBooking);

        boolean fullyBooked = Arrays
                .stream(seats)
                .allMatch(Seat::isReserved);
        System.out.println("Has booking = " + fullyBooked);

        boolean eventWashedOut = Arrays
                .stream(seats)
                .noneMatch(Seat::isReserved);
        System.out.println("Has booking = " + eventWashedOut);
    }
}
